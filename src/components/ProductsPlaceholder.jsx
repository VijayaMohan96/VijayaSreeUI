export default function ProductPlaceholder({ size = 40, fontSize = 18 }) {
  return (
    <div style={{
      ...
      <svg width={size * 0.6} height={size * 0.6} viewBox="0 0 24 24"
        ...
        <path d="M12 8C12 8 8 5 8 3C9.5 3.5 11 5 12 8Z"
          fill="#2d6a2d"/>
        <path d="M12 8C12 8 16 5 16 3C14.5 3.5 13 5 12 8Z"
          fill="#2d6a2d"/>
        <path d="M12 8C12 8 12 4 14 2C13 4 12 8 12 8Z"
          fill="#1a3c1a"/>
        <line x1="12" y1="8" x2="12" y2="18"
          stroke="#2d6a2d" strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M12 13C12 13 9 11 8 9C9.5 9 11 11 12 13Z"
          fill="#4a9e4a"/>
        <path d="M12 13C12 13 15 11 16 9C14.5 9 13 11 12 13Z"
          fill="#4a9e4a"/>
      </svg>
    </div>
  )
